...
CIT GERM OCC PHARMACIST OI CODES AA XX
POB GERM, BERLIN REP AACD-12345, 20 JUN 53 RCD DATE 53
SUBJECT RECENTLY ATTENDED THE SEVENTEENTH ANNUAL 30 NOV 70
...
1. Sequence Number and Name 8. 201 Number
2. Sex and Date of Birth 9. Name Type Indicator
3. Citizenship 10. OI Codes
4. Place of Birth 11. Record Date (year only)
5. Occupation 12. Reference
6. Occupation Code ISG Control Information
7. Text 13. Date of latest update of the record
Document Reference Data Group 14. STAR Index Record Number
...
For Split Charge Dossiers: All documents prior to (date) forwarded to IP/Files. All documents after (date) retained at desk.
