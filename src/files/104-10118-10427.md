```markdown
(104-10118-10427 | 2025 RELEASE UNDER THE PRESIDENT JOHN F. KENNEDY ASSASSINATION RECORDS ACT OF 1992)
...
Department of State have studied the entire problem of "cover."
They have reached an agreed formula for this cover and for correcting some
of the problems that attracted the attention of the Working Group. This
includes the Foreign Service designation. A new agreement has been
...
3.  The Comptroller is removed from the DD/S area, given greatly
    expanded responsibilities, and will report directly to the DCI/
    DDCI's office.
...
12. A Deputy Director for Research is created. This organization will
    ...
    Projects from DPD, all research and development from TSD, and
...
measures should be taken without impairing ability of Station to handle special costly situations which might
...
to research but should be tasked with operational responsibi-
...
responsibility between that of CIA or DD/R or personnel seconded from
...
We believe the DCI's office should also review all assign-
...
of this new organization be located at a location where it will have
...
Division of CO, which is to be transferred from the DD/I to the DD/P,
...
d. The conduct of rigorous field tests of these items
...
individuals, having them take and pass the Foreign Service exams
and be commissioned in the Foreign Service and follow through a
normal Foreign Service career. CIA should obviously keep the
Department advised concerning these individuals, work with the
...
integrate FDD and FBID into the most compatible area